...
var _wrs_conf_editorPath = '/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = '/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = '/pluginwiris_engine/app/editor';        // _wrs_conf_editorPath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/editor.php';				// Specifies where is the editor HTML code (for popup window).
var _wrs_conf_editorAttributes = 'width=570, height=450, scroll=no, resizable=yes';							// Specifies formula editor window options.
var _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = '/pluginwiris_engine/app/cas';        // _wrs_conf_CASPath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/cas.php';					// Specifies where is the WIRIS cas HTML code (for popup window).
var _wrs_conf_CASAttributes = 'width=640, height=480, scroll=no, resizable=yes';										// Specifies WIRIS cas window options.

var _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = '/pluginwiris_engine/app/createimage';        // _wrs_conf_createimagePath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/createimage.php';			// Specifies where is the createimage script.
var _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = '/pluginwiris_engine/app/createcasimage';        // _wrs_conf_createcasimagePath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/createcasimage.php';		// Specifies where is the createcasimage script.

var _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = '/pluginwiris_engine/app/getmathml';        // _wrs_conf_getmathmlPath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/getmathml.php';			// Specifies where is the getmathml script.
var _wrs_conf_servicePath = '/pluginwiris_engine/app/service';        // _wrs_conf_servicePath = '/pluginwiris_engine/app/service';        // _wrs_conf_servicePath = '/pluginwiris_engine/app/service';        // _wrs_conf_servicePath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/service.php';				// Specifies where is the service script.
var _wrs_conf_getconfigPath = '/pluginwiris_engine/app/getconfig';        // _wrs_conf_getconfigPath = '/pluginwiris_engine/app/getconfig';        // _wrs_conf_getconfigPath = '/pluginwiris_engine/app/getconfig';        // _wrs_conf_getconfigPath = _wrs_baseURL + '/plugins/tiny_mce_wiris/integration/getconfig.php';			// Specifies from where it returns the configuration using AJAX
