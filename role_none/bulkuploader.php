                ...
                <div class="card">
                 ...
                 if(isset($_POST["submitVal"])){ ?>
                    <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <button type="button" class="btn btn-primary waves-effect" id="upload_questions" onclick="submitAll('<?php echo basename($_FILES["file"]["name"]); ?>')">Submit All Questions</button>
                            </li>
                        </ul>
                        <?php } ?>
