                                    ...
                                    for($i=0; $i<$size; $i++)
                                        {?>
                                            <tr id=" <?php echo $feed['data'][$i]['id'] ?>" >
                                                <td><button class='questionAdd btn btn-success waves-effect' id="<?php echo 'questionAdd'.$feed['data'][$i]['id'] ?>" onclick='addQuestion(<?php echo $feed['data'][$i]['id'] ?>)'>Add to my paper</button>
                                                <button style="display: none;" class=' questionRemove btn btn-danger waves-effect' id="<?php echo 'questionRemove'.$feed['data'][$i]['id'] ?>" >Remove</button></td>
                                                <td><?php echo $i; ?></td>
